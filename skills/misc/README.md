...
- `app-idea` - golden-track intake->verdict for consumer/AI app ideas; writes verdict cards to ~/wiki/playbook/verdicts and ratchets owner overrides into ~/wiki/playbook/apps.md.
